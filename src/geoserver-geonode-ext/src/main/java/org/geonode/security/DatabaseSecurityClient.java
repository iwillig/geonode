...
public class DatabaseSecurityClient implements GeonodeSecurityClient {
    ...
    private final Collection<GrantedAuthority> ADMIN_AUTHORITY = 
            Collections.singleton(GeoNodeDataAccessManager.ADMIN_AUTHORITY);
    ...
    private Authentication authenticate(final Object credentials, final String... requestHeaders)
        ...
        final String url = baseUrl + "data/user_name";
